...
namespace RockWeb.Blocks.EventsList
{
    /// <summary>
    ...
    [Category( "Event" )]
    [Description( "Renders a list of events and filters using Lava." )]
    ...
    [LinkedPage( "Featured Events Page", "List of Featured Events", false, order: 2 )]
    ...
    public partial class CalendarLava : Rock.Web.UI.RockBlock
    {
        ...
        protected String FeaturedEventsPage { get; set; }
        
        public string FeaturedEventsPageUrl 
        {
          get 
          {
             return LinkedPageUrl( "FeaturedEventsPage", null );
          }
        }
        ...
        private void BindData()
        {
            ...
            mergeFields.Add( "FeaturedEventsPage", LinkedPageUrl( "FeaturedEventsPage", null ));
        ...
        private bool SetFilterControls()
        {
            ...
            // Get the first/last dates based on todays date and the viewmode setting
            var today = RockDateTime.Today;
            ...
            cblCampus.DataSource = CampusCache.All().Where(c => c.IsActive == true).ToList();
            cblCampus.DataBind();
