<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EventsList.ascx.cs" Inherits="RockWeb.Blocks.EventsList.CalendarLava" %>
<div id="all-events" class="events_tab">
  <asp:UpdatePanel ID="upnlContent" runat="server">
    ...
    <ContentTemplate>
      ...
      <div class="filters">
        ...
        <% if (!String.IsNullOrEmpty(FeaturedEventsPageUrl)) { %>
        <div class=" pull-right text-right">
        <ul class="inline-buttons">
        <li class="toggle"><a href="<%= FeaturedEventsPageUrl %>" title="Featured Events"><i class="vc-icon-grid"></i>Featured</a></li>
        <li class="active toggle"><a href="/all-events" title="All Events"><i class="vc-icon-list"></i>All Events</a></li>
        </ul>
        </div>
        <% } %>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9 column">
            <asp:Panel ID="pnlList"  runat="server">
              <h2 class="panel_title">Events</h2>
