        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <asp:LinkButton ID="lbEventCalenderAttributes" runat="server" CssClass="btn btn-default btn-xs" OnClick="lbEventCalenderAttributes_Click" CausesValidation="false"><i class="fa fa-gear"></i></asp:LinkButton>
                    <asp:LinkButton ID="lbAddEventCalendar" runat="server" CssClass="btn btn-action btn-xs" OnClick="lbAddEventCalendar_Click" CausesValidation="false"><i class="fa fa-plus"></i></asp:LinkButton>
                </div>
            </div>
